...
%global pkg_name easynav_fusion_localizer
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-easynav-fusion-localizer
Version:        0.4.2
Release:        2%{?dist}
...
%changelog
* Thu Jul 30 2026 Miguel Ángel de Miguel <miguelangel.demgiuel@urjc.es> - 0.4.2-2
- Autogenerated by Bloom

* Sun Jul 26 2026 Miguel Ángel de Miguel <miguelangel.demgiuel@urjc.es> - 0.4.2-1
- Autogenerated by Bloom
