...
%global pkg_name easynav_mppi_controller
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-easynav-mppi-controller
Version:        0.4.2
Release:        2%{?dist}
...
%changelog
* Thu Jul 30 2026 Jose Miguel Guerrero Hernandez <josemiguel.guerrero@urjc.es> - 0.4.2-2
- Autogenerated by Bloom

* Sun Jul 26 2026 Jose Miguel Guerrero Hernandez <josemiguel.guerrero@urjc.es> - 0.4.2-1
- Autogenerated by Bloom
