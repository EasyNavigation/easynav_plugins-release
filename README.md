...
## easynav_plugins (jazzy) - 0.4.0-1

The packages in the `easynav_plugins` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release easynav_plugins --rosdistro jazzy` on `Sun, 26 Jul 2026 08:46:16 -0000`
...
## easynav_plugins (kilted) - 0.3.1-1

The packages in the `easynav_plugins` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted easynav_plugins` on `Fri, 27 Feb 2026 16:56:15 -0000`
...
## easynav_plugins (jazzy) - 0.2.1-2

The packages in the `easynav_plugins` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy easynav_plugins` on `Fri, 27 Feb 2026 16:35:16 -0000`
...
## easynav_plugins (jazzy) - 0.2.1-1

The packages in the `easynav_plugins` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy easynav_plugins` on `Fri, 27 Feb 2026 16:18:43 -0000`
...
## easynav-plugins (kilted) - 0.0.2-1

The packages in the `easynav-plugins` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted easynav-plugins --edit` on `Sun, 12 Oct 2025 17:07:48 -0000`
...
Version of package(s) in repository `easynav-plugins`:
